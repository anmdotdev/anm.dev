...
const Intro = () => (
  <section className="mx-auto w-full max-w-lg pt-10 pb-8 max-sm:px-6">
    ...
    <p className="mb-6 dark:text-dark-text-secondary">
      I am a remote{' '}
      <strong className="font-medium dark:text-dark-text">Staff Frontend Engineer</strong>, based in
      ...
      , and have a total of{' '}
      <strong className="font-medium dark:text-dark-text">about 10 years of experience</strong> as
      an engineer.
    </p>
    <p className="mb-6 dark:text-dark-text-secondary">
      Over the span of 10 years, I have worked with a{' '}
      <strong className="font-medium dark:text-dark-text">range of Frontend initiatives</strong>,
      including multiple{' '}
      <strong className="font-medium dark:text-dark-text">
