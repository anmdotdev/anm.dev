...
If [voice-first prompting](/blog/voice-first-ai-coding) fixes the input side of AI coding, this post is about the output side: the verification loop that keeps plausible code from staying wrong.
