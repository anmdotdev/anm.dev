...
summary: "Maintainability still matters. But in the AI era, the real source of truth is shifting upward: from hand-crafted code to clearly declared intent, documentation, scenarios, and tests."
