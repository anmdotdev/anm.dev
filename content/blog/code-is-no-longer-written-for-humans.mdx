...
summary: "Maintainability still matters, but AI shifts the real source of truth upward: from hand-written code to specs, scenarios, docs, and tests."
...
If you want the practical side of this argument, the companion posts on [voice-first prompting](/blog/voice-first-ai-coding) and [AI feedback loops](/blog/ai-coding-feedback-loops) show how this shift changes day-to-day implementation work.
...
The problem is that the code is not the full source of truth anymore.
...
This is what I mean when I say English is becoming the new programming language. Not because code disappears. Not because natural language is magically precise. But because natural language is increasingly the layer where we describe behavior before code exists.
...
If you buy the argument so far, two things become much more important than most teams currently treat them.
...
That is why I think many teams are aiming at the wrong target. They are obsessing over whether AI-generated code "looks like us," instead of asking whether the behavior is clearly specified and mechanically verified.
...
The goal is not to produce code that wins a style argument.
