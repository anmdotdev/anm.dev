...
socialDescription: "Code is no longer written primarily for humans to read line by line. It is increasingly written as the executable output of a clearer layer above it: intent."
