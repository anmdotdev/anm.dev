...
summary: "Voice-first prompting is not about talking faster. It is about making rich context cheap enough to provide, which improves AI coding output."
...
It also sets up the rest of this series: [prompts work better as specs](/blog/prompts-are-declarative-code) only when enough context actually makes it into the handoff.
...
If you gave that same task to another developer on your team, you would not stop there. You would say:
...
**Use voice for context-heavy prompts, not for tiny edits.** I am not dictating "rename this variable."
