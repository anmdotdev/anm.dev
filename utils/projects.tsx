export const OPEN_SOURCE_PROJECTS = [
  {
    ...
    tags: [
      { label: 'NPM Library', color: 'success' },
      { label: 'React', color: 'warn' },
      { label: 'TypeScript', color: 'purple' },
      { label: 'Rollup', color: 'error' },
    ],
    npmName: 'cogo-toast',
  ...
  },
  {
    ...
    tags: [
      { label: 'React', color: 'warn' },
      { label: 'TypeScript', color: 'purple' },
      { label: 'Next.js', color: 'error' },
      { label: 'TailwindCSS', color: 'warn' },
      { label: 'Preact', color: 'purple' },
    ],
